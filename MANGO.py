...
if menu == "🏠 Home":
    ...
    if disease_info == "Leaf Anthracnose":
        st.image(
            "https://www.multiplexgroup.com/assets/images/mango-anthracnose1.jpg",
            width=400
        )
        ...
        **Symptoms**
        ...
        st.image(
            "https://content.peat-cloud.com/w400/black-banded-disease-mango-1716469945.jpg",
            width=400
        )
        ...
        **Symptoms**
        ...
        st.image(
            "https://huntinorganics.com/wp-content/uploads/2024/03/Mango-Alga-leaf-spot.jpg",
            width=400
        )
        ...
        **Symptoms**
        ...
        st.image(
            "https://us-central1-plantix-8e0ce.cloudfunctions.net/v1/image/w400/cfd59802-a9eb-42c1-b76c-aacd73b4c886",
            width=400
        )
        ...
        **Symptoms**
        ...
        st.image(
            "https://pestsdiseases.com/wp-content/uploads/Mango-Sooty-Mould-Disease-Management-1.jpg",
            width=400
        )
